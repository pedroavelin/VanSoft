 ...
 * @author Gonga
 */
public class NotaDeDebito55 extends javax.swing.JFrame {
    ...
    public NotaDeDebito55(int id, String perfil, String caminho) {
        initComponents();
...
//            initComponents();
     ...
     public boolean CreateNota(String idfactura) {
        ...
        try {
            ...
            PreparedStatement pst = liga.con.prepareStatement("Insert into nota_de_debito (idcliente,data,valor,observacao,objectivo,idfactura) values (?,?,?,?,?,?);");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jTextField_valor, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                       ...
                       // ModeloUtilizador MU = null;
                        e.setMU(MU);
                        e.setMC(MC);
                        e.exportA42_NotaDebito("Nota de débito", "",jList4.getSelectedValue(),Double.parseDouble(this.jTextField_valor.getText()),jTextField_objectivo.getText());
    ...
    private void jTextField_identificacaoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_identificacaoKeyReleased
        if (this.jComboBox1.getSelectedIndex() == 0) {
            ...
            try {
                ...
                Logger.getLogger(NotaDeDebito55.class.getName()).log(Level.SEVERE, null, ex);
            }
            liga.deconecta();
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotaDeDebito55.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotaDeDebito55().setVisible(true);
            }
        });
    }
    ...
    private void BuscarFacturas(String Ident) {
        ...
        liga.conexao();
        liga.executeSql("select idfatura_recibo from recibo WHERE idcliente = " + Ident + " AND idfatura_recibo NOT IN (select idfactura from nota_de_debito) Order by idfatura_recibo");
