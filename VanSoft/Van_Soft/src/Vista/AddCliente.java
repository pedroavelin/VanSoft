...
public class AddCliente extends javax.swing.JFrame {
    ...
    public AddCliente(int id, String perfil, String caminho) {
        initComponents();
        Toolkit T = Toolkit.getDefaultToolkit();
        this.setSize(T.getScreenSize());
        this.setExtendedState(this.MAXIMIZED_BOTH);
    ...
    public boolean CreateCliente() {
        ...
        try {
            ...
            ModeloCliente MT = new ModeloCliente(-1, this.jTextField_designacao.getText(), this.jTextField_pais.getText(),
            ...
            MT.setEndereco(jTextField_casa.getText() + ", " + jTextField_rua.getText() + ", " + jTextField_cidade.getText() + ", " + jTextField_pais.getText());
            PreparedStatement pst = liga.con.prepareStatement("Insert into cliente"
                    + "(designacao,endereco,cidade, bi, nif,tipo_de_pessoa, email,sexo, telefone, foto,nome_da_foto,casa,rua,provincia,pais) "
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
            ...
            pst.setString(8, MT.getSexo());
            pst.setString(9, MT.getTelefone());
            pst.setBytes(10, this.photo);
            pst.setString(11, MT.getFoto());
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Adicionar cliente ");
        ...
        jLabel21.setText("Registo de um novo cliente");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel10_validacao_nif, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)
                    ...
                    .addComponent(jTextField_NIF, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTextField_designacao)
                    .addComponent(jComboBox_Pessoa, javax.swing.GroupLayout.Alignment.TRAILING, 0, 207, Short.MAX_VALUE)
                    .addComponent(jTextField_rua)
                    .addComponent(jTextField_casa))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jComboBox_PessoaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox_PessoaItemStateChanged
        if (jComboBox_Pessoa.getSelectedItem().toString().equals("Jurídica")) {
            ...
            this.jTextField_bi.setVisible(false);
        ...
        if (jComboBox_Pessoa.getSelectedItem().toString().equals("Física")) {
            ...
            this.jTextField_bi.setVisible(true);
        }
