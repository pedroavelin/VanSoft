...
public class EditarFornecedor extends javax.swing.JFrame {
    ...
    public EditarFornecedor() {
        initComponents();
        TextPrompt prompt1 = new TextPrompt("Nome de utilizador", jTextField_designacao);
        TextPrompt prompt2 = new TextPrompt("Nome de usuário", jTextField_endereco);
        TextPrompt prompt5 = new TextPrompt("Número de Identificação Fiscal", jTextField_bi);
        TextPrompt prompt6 = new TextPrompt("Número de telefone", jTextField_NIF);
        TextPrompt prompt7 = new TextPrompt("Nome de utilizador", jTextField_designacao);
        TextPrompt prompt8 = new TextPrompt("endereço de email", jTextField_cidade);

    }

    public EditarFornecedor(int id, String perfil, ModeloFornecedor MF, String caminho) {
        initComponents();
        this.id = id;
        this.perfil = perfil;
        liga.setCaminho(caminho);
        this.idForn = MF.getIdFornecedor();
        ...
        liga.conexao();
        liga.executeSql("select * from fornecedor WHERE idfornecedor = " + this.idForn);
        try {
            if (liga.rs.first()) {
                ...
                this.jTextArea1.setText(liga.rs.getString("dados_da_oferta"));
                String s = liga.rs.getString("sexo");
                String pessoa = liga.rs.getString("tipo_de_oferta");
    ...
    public boolean UpdateFornecedor() {
        ...
        try {
            ...
            PreparedStatement pst = liga.con.prepareStatement("UPDATE fornecedor SET "
                    + "designacao=?,endereco=?,cidade=?, bi=?, nif=?,tipo_de_pessoa=?, email=?,dados_da_oferta=?,sexo=?, nome_da_foto=?,telefone=?,tipo_de_oferta=?,foto=? WHERE idfornecedor = " + this.idForn);
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Editar fornecedor ");
        ...
        jLabel21.setText("Alterar registo do fornecedor");
