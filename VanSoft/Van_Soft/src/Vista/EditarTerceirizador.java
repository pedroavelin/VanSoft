 ...
 * @author Gonga
 */
public class EditarTerceirizador extends javax.swing.JFrame {
    ...
    public EditarTerceirizador(int id, String perfil, ModeloTerceirizador mt, String caminho) {
        initComponents();
        ...
        try {
            ...
            this.idter = mt.getIdterceirizador();

            liga.conexao();
            liga.executeSql("select * from terceirizador WHERE idterceirizador = " + this.idter);
            if (liga.rs.first()) {
                ...
                this.jTextField_endereco.setText(liga.rs.getString("endereco"));
...
//                    jComboBox_Pessoa.removeAllItems();
                    jComboBox_Pessoa.setSelectedIndex(0);
//                    jComboBox_Pessoa.addItem("Física");
//                    jComboBox_Pessoa.addItem("Jurídica");
                } else {
...
//                    jComboBox_Pessoa.addItem("Física");
    ...
    public boolean UpdateTerceirizador() {
        ...
        try {
            ...
            ModeloTerceirizador MT = new ModeloTerceirizador(-1, this.jTextField_designacao.getText(), this.jTextField_endereco.getText(), this.jTextField_bi.getText(),
                    this.jTextField_cidade.getText(), this.jTextField_NIF.getText(), jComboBox_Pessoa.getSelectedItem().toString(), this.jTextField_email.getText(), null, jTextField_nomeDaFoto.getText(), this.jTextField_telefone.getText(), sexo);

            PreparedStatement pst = liga.con.prepareStatement("Update terceirizador"
                    + "set designacao=?, endereco=?, cidade=?, bi=?, nif=?,tipo_de_pessoa=?, email=?,dados_do_servico=?,sexo=?, nome_da_foto=?,telefone=?,foto=? WHERE idterceirizador = "+this.idter);
            pst.setString(1, MT.getDesignacao());
            pst.setString(2, MT.getEndereco());
            pst.setString(3, MT.getCidade());
            pst.setString(4, MT.getBairro());
            pst.setString(5, MT.getNif());
            pst.setString(6, MT.getTipo_de_pessoa());
            pst.setString(7, MT.getEmail());
            pst.setString(8, MT.getDados_do_servico());
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Editar terceirizador ");
        ...
        jComboBox_Pessoa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jComboBox_PessoaMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(jTextField_bi, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel21.setText("Alterar registo do terceirizador");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Observações do terceirizador"));

        jTextField1.setText("jTextFieldNomeDoServico");
    ...
    private void jComboBox_PessoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jComboBox_PessoaMouseClicked


    }//GEN-LAST:event_jComboBox_PessoaMouseClicked
    ...
    private void jComboBox_PessoaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox_PessoaItemStateChanged
        ...
        if (jComboBox_Pessoa.getSelectedItem().toString().equals("Física")) {
            ...
            this.jRadioButton_SM.setSelected(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarTerceirizador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarTerceirizador().setVisible(true);
            }
        });
    }
