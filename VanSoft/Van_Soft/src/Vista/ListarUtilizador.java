 ...
 * @author Gonga
 */
public class ListarUtilizador extends javax.swing.JFrame {
    ControloBD liga = new ControloBD();
    String select;
    /**
     * Creates new form ListarUtilizador
     */
    public ListarUtilizador() {
        initComponents();
        TextPrompt prompt1 = new TextPrompt("Pesquisar", jTextField_Filtrar);
        this.select = "select * from utilizador";
        PreencherTabela("select * from utilizador ");
    }
    
    public ListarUtilizador(String caminho) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox_Filtrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "email", "nome", "perfil", "sexo" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        System.out.println(this.select+" order by " + this.jComboBox_OrdenarUtilizador.getSelectedItem().toString());
        PreencherTabela(this.select+" order by " + this.jComboBox_OrdenarUtilizador.getSelectedItem().toString());
    ...
    private void jButton_FiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_FiltrarActionPerformed
        ...
        this.select = "select * from utilizador where "+colum+" ilike '%"+this.jTextField_Filtrar.getText()+"%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarUtilizador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarUtilizador().setVisible(true);
            }
        });
    }
    ...
    public void PreencherTabela(String Sql) {
        ...
        try {
         ...
         JTableUtilizadores.setModel(modelo);
        JTableUtilizadores.getColumnModel().getColumn(0).setPreferredWidth(60);
        JTableUtilizadores.getColumnModel().getColumn(0).setResizable(false);
        JTableUtilizadores.getColumnModel().getColumn(1).setPreferredWidth(160);
        JTableUtilizadores.getColumnModel().getColumn(1).setResizable(true);
        JTableUtilizadores.getColumnModel().getColumn(2).setPreferredWidth(160);
        JTableUtilizadores.getColumnModel().getColumn(2).setResizable(true);
        JTableUtilizadores.getColumnModel().getColumn(3).setPreferredWidth(160);
        JTableUtilizadores.getColumnModel().getColumn(3).setResizable(true);
        JTableUtilizadores.getColumnModel().getColumn(4).setPreferredWidth(160);
        JTableUtilizadores.getColumnModel().getColumn(4).setResizable(true);
        JTableUtilizadores.getColumnModel().getColumn(5).setPreferredWidth(140);
        JTableUtilizadores.getColumnModel().getColumn(5).setResizable(false);
        JTableUtilizadores.getColumnModel().getColumn(6).setPreferredWidth(140);
        JTableUtilizadores.getColumnModel().getColumn(6).setResizable(false);
        JTableUtilizadores.getColumnModel().getColumn(7).setPreferredWidth(60);
        JTableUtilizadores.getColumnModel().getColumn(7).setResizable(false);
        JTableUtilizadores.getColumnModel().getColumn(8).setPreferredWidth(145);
        JTableUtilizadores.getColumnModel().getColumn(8).setResizable(false);
        JTableUtilizadores.getTableHeader().setReorderingAllowed(false);
        JTableUtilizadores.setAutoResizeMode(JTableUtilizadores.AUTO_RESIZE_ALL_COLUMNS);
