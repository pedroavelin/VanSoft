...
public class EditarColaborador extends javax.swing.JFrame {
    ...
    public EditarColaborador(ModeloColaborador MC, int id, String perfil, String caminho) {
        try {
            initComponents();
            ...
            this.id = id;
            this.perfil = perfil;
            this.idColab = MC.getId();
            liga.conexao();
            liga.executeSql("select * from colaborador WHERE idcolaborador = " + this.idColab);
            if (liga.rs.first()) {

                this.jTextField_nome.setText(liga.rs.getString("nome_completo"));
                ...
                this.jTextField_Telefone1.setText(liga.rs.getString("telefone1"));
                this.jTextField_Telefone1.setText(liga.rs.getString("telefone2"));
                this.jTextField_nomeDaFoto.setText(liga.rs.getString("nome_da_foto"));
                this.jTextField_funcao.setText(liga.rs.getString("funcao"));
                this.jTextField_ibam.setText(liga.rs.getString("ibam"));
    ...
    public boolean UpdateColaborador() {
        ...
        try {
            ...
            PreparedStatement pst = liga.con.prepareStatement("UPDATE colaborador "
                    + "set nome_completo=? ,bi=?, nif=?, email=?, sexo=?, nome_da_foto=?, ibam=?,telefone1=?,telefone2=?,funcao=?, foto=? "
                    + "WHERE idcolaborador = " + this.idColab);
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Editar colaborador ");
        ...
        jLabel21.setText("Alterar registo do colaborador");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel10_validacao_funcao, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jTextField_Telefone2, javax.swing.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                .addComponent(jTextField_Telefone1)
                                .addComponent(jLabel10_validacao_telf1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextField_Telefone2, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextField_funcao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jDesktopPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel_Foto, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
                .addContainerGap())
        );
        jDesktopPane1Layout.setVerticalGroup(
            jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel_Foto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextField_nomeDaFoto))
                .addGap(81, 81, 81))
        );
        ...
        jPanel_Add_colaborador.add(jPanel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 900, 530));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (validacao.ValidarTelef(this.jTextField_Telefone1.getText())) {
            ...
            this.jLabel10_validacao_telf1.setText("Entrada inválida. Ex: +244999111222");
        ...
        if (r1 && r2 && r3 && r4 && r5 && r6) {
            UpdateColaborador();
            new EditarColaborador(new ModeloColaborador(this.idColab), this.id, this.perfil, liga.getCaminho()).setVisible(true);
            this.dispose();
        }
