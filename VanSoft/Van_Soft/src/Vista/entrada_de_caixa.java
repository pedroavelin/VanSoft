 ...
 * @author Gonga
 */
public class entrada_de_caixa extends javax.swing.JFrame {
    ...
    public entrada_de_caixa(int id, String perfil, String caminho) {
        initComponents();
        Toolkit T = Toolkit.getDefaultToolkit();
        this.setSize(T.getScreenSize());
        this.setExtendedState(this.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Entrada de caixa");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (this.perfil.equals("Administrador") || this.perfil.equals("Secretário")){
                CreatEntrada(this.id,saldoR,valor);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(entrada_de_caixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new entrada_de_caixa().setVisible(true);
            }
        });
    }
    ...
    public boolean CreatEntrada (int idUtilizador, Double saldoR,Double valor) {
        liga.conexao();
        
         
        try {
            PreparedStatement pst = liga.con.prepareStatement("INSERT INTO public.entada_de_caixa(\n" +
...
"    VALUES ("+valor+", "+saldoR+", '"+this.jTextArea2.getText()+"', '"+this.jTextArea1.getText()+"', "+this.id+", '"+new Tempo().Date()+" "+new Tempo().Hours()+"');");
    ...
    public void UpdateSaldo(double valor) {
        try {
            liga.conexao();
            PreparedStatement pst = liga.con.prepareStatement("UPDATE caixa set entrada = entrada + "+valor+", saldo = saldo + "+valor+", idempresa =" + 1);
            pst.execute();
            pst = liga.con.prepareStatement("UPDATE turno set saldo_atual = saldo_atual + " + valor + ", entrada_em_caixa = entrada_em_caixa + " + valor + " WHERE idturno =" + this.id_turno);
                pst.execute();
            liga.deconecta();
        } catch (SQLException ex) {
