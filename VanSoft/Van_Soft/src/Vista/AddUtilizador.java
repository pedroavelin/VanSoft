...
public class AddUtilizador extends javax.swing.JFrame {
    ...
    public AddUtilizador(int idutilizador, String perfil, String caminho) {
        initComponents();
        Toolkit T = Toolkit.getDefaultToolkit();
        this.setSize(T.getScreenSize());
        this.setExtendedState(this.MAXIMIZED_BOTH);
    ...
    public boolean CreateUtilizador() {
        ...
        try {
            ...
            Modelo.ModeloUtilizador MU = new ModeloUtilizador(jTextField_nome_UTILIZADOR.getText(), jTextField_nome.getText(),
                    ...
                    Integer.parseInt(jTextField_Telefone.getText()));
            ...
            pst.setString(8, MU.getSenha());
            pst.execute();
            JOptionPane.showMessageDialog(null, "Dados Inseridos com sucesso.", "Guardado.", JOptionPane.INFORMATION_MESSAGE);
            return true;
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Utilizador não inserido " + ex,"Aviso" ,JOptionPane.WARNING_MESSAGE);
        }
        liga.deconecta();
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Adicionar utilizador ");
        ...
        jLabel21.setText("Adicionar credenciais de entrada");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabel15_validacao, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jPasswordField_senha.getText().length() >= 8) {
            if (jPasswordField_senha.getText().equals(jPasswordField_confirmarSenha.getText())) {
                if (r1 && r2 && r3 && r4 && r5) {
                    CreateUtilizador();
            ...
            JOptionPane.showMessageDialog(null, "A senha deve ter no mínimo 8 caracteres.", "Senha muito fraca.", JOptionPane.WARNING_MESSAGE);
