 ...
 * @author Gonga
 */
public class AddTerceirizador extends javax.swing.JFrame {
    ...
    public AddTerceirizador(int id, String perfil,String caminho) {
        initComponents();
        Toolkit T = Toolkit.getDefaultToolkit();
        this.setSize(T.getScreenSize());
        this.setExtendedState(this.MAXIMIZED_BOTH);
    ...
    public boolean CreateTerceirizador() {
        ...
        try {
            ...
            PreparedStatement pst = liga.con.prepareStatement("Insert into terceirizador"
                    + "(designacao,endereco,cidade, bi, nif,tipo_de_pessoa, email,dados_do_servico,sexo, nome_da_foto,telefone,foto) values(?,?,?,?,?,?,?,?,?,?,?,?);");
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Adicionar terceirizador ");
        ...
        jLabel21.setText("Registo de um novo terceirizador");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddTerceirizador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddTerceirizador().setVisible(true);
            }
        });
    }
