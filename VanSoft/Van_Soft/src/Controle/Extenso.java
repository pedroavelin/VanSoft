...
public class Extenso {
    ...
    public String getMeoda() {
        return meoda;
    }

    public void setMeoda(String meoda) {
        this.meoda = " "+meoda;
    }
...
// Se ja existe texto e o atual não é zero 
    ...
    private boolean ehPrimeiroGrupoUm() {
        if (((Integer) nro.get(n­ro.size() - 1)).intValue() == 1) {
            return true;
        }
        return false;
    }
...
//        System.out.println(nf.getCurrency());
    ...
    public String Chang(String V) {
        BigDecimal valor = new BigDecimal(V);
        NumberFormat nf = NumberFormat.getInstance(Locale.ITALY);
////        System.out.println("Formato"+nf);
        String formatado = nf.format(valor);
//        String r = formatado.substring(0, formatado.length() - 2);
        return formatado;
    }
